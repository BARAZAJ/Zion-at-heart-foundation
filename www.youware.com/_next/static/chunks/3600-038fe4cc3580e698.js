try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "e4097e12-2ad9-4b55-ad81-bda0d2892490", e._sentryDebugIdIdentifier = "sentry-dbid-e4097e12-2ad9-4b55-ad81-bda0d2892490")
} catch (e) {}
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [3600], {
        1021: (e, t, r) => {
            ...
            var l, n, a = r(95155),
                s = r(12115);
            null === (n = globalThis || window) || void 0 === n || null === (l = n.requestIdleCallback) || void 0 === l || l.call(n, () => r.e(9066).then(r.t.bind(r, 48834, 23)));
            let i = e => {
                let {
                    animationPath: t,
                    animationData: l,
                    ...
                    onError: p,
                    onLoad: m
                } = e, v = (0, s.useRef)(null), [x, h] = (0, s.useState)(null), [g, w] = (0, s.useState)(!0);
                return ((0, s.useEffect)(() => {
                    ...
                    return (async () => {
                        try {
                            h(null), w(!0);
                            let a = (await r.e(9066).then(r.t.bind(r, 48834, 23))).default;
                            ...
                            (e = a.loadAnimation({
                                ...
                                n && (h("Lottie loading error"), w(!1), null == p || p("Lottie loading error"))
                            })
                        } catch (e) {
                            n && (h("Lottie loading error"), w(!1), null == p || p("Lottie loading error"))
                        }
                ...
                }, [t, c, u, o]), x && d) ? d : g && f ? f : (0, a.jsx)("div", {
                    ref: v,
                    className: n,
                    style: i
                })
            ...
            let i = (0, a.createContext)(void 0),
                ...
                c = e => {
                    let {
                        ...
                        hoverDelay: o = 300,
                        onOpenChange: c
                    } = e, [u, d] = (0, a.useState)(!1), f = (0, a.useRef)(null), p = (0, a.useRef)(null), m = (0, a.useRef)(null), v = (0, a.useRef)(null), x = (0, a.useRef)(null);
                    return (0, a.useEffect)(() => {
                        if (u) {
                            let e = e => {
                                var t;
                                !p.current || p.current.contains(e.target) || (null === (t = f.current) || void 0 === t ? void 0 : t.contains(e.target)) || (e.stopPropagation(), e.preventDefault(), d(!1))
                            };
                        ...
                        v.current && clearTimeout(v.current), x.current && clearTimeout(x.current)
                    }, []), (0, a.useEffect)(() => {
                        null == c || c(u)
                    }, [u, c]), (0, l.jsx)(i.Provider, {
                        value: {
                            isOpen: u,
                            setIsOpen: d,
                            triggerRef: f,
                        ...
                        children: (0, l.jsx)("div", {
                            ...
                            onMouseLeave: "hover" === n ? () => {
                                x.current && (clearTimeout(x.current), x.current = null), v.current = setTimeout(() => {
                                    d(!1)
                                }, 200)
                            } : void 0,
                ...
                u = e => {
                    ...
                    return (0, l.jsx)("div", {
                        ref: a,
                        className: (0, s.cn)("cursor-pointer", r),
                        onClick: e => {
                            e.stopPropagation(), e.preventDefault(), "click" === i ? n(e => !e) : n(!0)
                        },
                        onMouseEnter: () => {
                            "hover" === i && (u.current && (clearTimeout(u.current), u.current = null), c.current = setTimeout(() => {
                                n(!0)
                            }, d))
                        },
                        onMouseLeave: () => {
                            "hover" === i && c.current && (clearTimeout(c.current), c.current = null)
                        },
                        children: t
                    })
                },
                d = e => {
                    ...
                    return n ? (0, l.jsx)("div", {
                        ref: a,
                        className: (0, s.cn)("absolute z-50 space-y-1 rounded-[10px] bg-white p-1 shadow-[0px_16px_48px_1px_rgba(12,12,13,0.1)]", r),
                        children: t
                    }) : null
                },
                f = e => {
                    let {
                        ...
                        setIsOpen: p
                    } = o(), [m, v] = (0, a.useState)(!1);
                    return (0, l.jsx)("div", {
                        className: (0, s.cn)("flex h-[30px] cursor-pointer items-center justify-between gap-2 rounded-[8px] px-2 hover:bg-black/3", u && "cursor-not-allowed text-black/30", t),
                        onClick: async e => {
                            if (e.stopPropagation(), e.preventDefault(), !u) try {
                                v(!0), await f(e), v(!1), p(!1)
                            } catch (e) {
                                v(!1)
                            }
                        },
        ...
        70165: (e, t, r) => {
            ...
            var l = r(49509);
            let n = "0000000000000000000000000000",
                a = "00000000-0000-0000-0000-000000000000";
            l.env.JWT_SECRET_KEY;
            let s = "header_banner_close_date",
                i = "first_time_favorite_users",
                o = "first_time_new_mcp_tips",
        ...
        78161: (e, t, r) => {
            ...
            var l = r(95155),
                ...
                a = r(1021),
                s = function(e) {
                    return e.Image = "image", e.Video = "video", e.Unsupported = "unsupported", e
                }(s || {});
            let i = ["jpg", "jpeg", "png"],
                o = ["mp4"],
                c = e => {
                    ...
                    let l = new URL(e).pathname.split("."),
                        n = l.length > 1 && null !== (r = null === (t = l.pop()) || void 0 === t ? void 0 : t.toLowerCase()) && void 0 !== r ? r : "";
                    return o.includes(n) ? "video" : i.includes(n) ? "image" : "unsupported"
                },
                u = e => {
                    let {
                        isLoading: t
            ...
            let p = (0, n.forwardRef)((e, t) => {
                    let {
                        url: r,
                        className: a
                    } = e, s = (0, n.useRef)(null), [i, o] = (0, n.useState)(!1);
                    return (0, n.useEffect)(() => {
                        t && "object" == typeof t && (t.current = {
                            play: () => {
                                if (!e.alwaysAnimated) {
                                    var t;
                                    null === (t = s.current) || void 0 === t || t.play()
                                }
                            },
                            pause: () => {
                                if (!e.alwaysAnimated) {
                                    var t;
                                    null === (t = s.current) || void 0 === t || t.pause()
                                }
                            }
                        })
                    }, [e.alwaysAnimated]), (0, l.jsx)("div", {
                        className: "relative h-full w-full overflow-hidden bg-black/3 ".concat(a),
                        children: i ? (0, l.jsx)(u, {
                            isLoading: !1
                        }) : (0, l.jsx)("video", {
                            ref: s,
                            src: r,
                ...
                m = (0, n.memo)((0, n.forwardRef)((e, t) => {
                    if (e.isUploading) return (0, l.jsx)(d, {});
                    switch (c(e.url)) {
                        case "image":
                            return (0, l.jsx)(f, { ...e
                            });
