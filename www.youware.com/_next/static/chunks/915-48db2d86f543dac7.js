try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "db06a04d-fbe8-4681-b5ac-1150a36f6501", e._sentryDebugIdIdentifier = "sentry-dbid-db06a04d-fbe8-4681-b5ac-1150a36f6501")
} catch (e) {}
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [915], {
        707: (e, t, l) => {
            ...
            var r = l(34477);
            let a = (0, r.createServerReference)("40765cd84cf16f0018a5e81b1c99cc16ea5026c8eb", r.callServer, void 0, r.findSourceMapURL, "checkSlugPrefix")
        },
        46116: (e, t, l) => {
            l.d(t, {
                p: () => p,
            ...
            function n() {
                ...
                return {
                    ...
                    checkCreditsAndShow: () => ((null == l ? void 0 : l.total_credits) || 0) > 0 || (t(!0), !1)
                }
            }
            var c = l(95155),
                s = l(25427),
            ...
            let p = e => {
                ...
                return t ? (0, o.createPortal)((0, c.jsx)("div", {
                            ...
                            children: [(0, c.jsx)("div", {
                                ...
                                onClick: () => {
                                    (null == a ? void 0 : a.uid) && (n("sub_upgrade_click", {
                                        click_from: r
                                    }), window.open("/subscription?openSelector=true", "_blank")), l()
                                },
        ...
        80246: (e, t, l) => {
            ...
            let d = e => {
                    let {
                        ...
                        track: d
                    } = (0, s.s)(), p = t.visibility === o.wg.PUBLIC, u = "".concat(window.location.origin).concat(t.project_url, "?enter_from=share");
                    return (0, n.useEffect)(() => {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                onClick: () => {
                                    let e = p ? u : "Link: ".concat(u, "\nPasscode: ").concat(t.passcode);
                                    navigator.clipboard.writeText(e), (0, i.P)({
                                        message: p ? "Link copied to clipboard" : "Link and passcode copied to clipboard",
                                        type: "success",
                                        icon: !p && (0, r.jsx)(a.XJr, {
                                            className: "h-4 w-4 text-[#14AE5C]"
                                        })
                                    }), d("share_copy_link_click", {
                                        project_id: t.project_id,
                                        project_url: t.project_url,
                                        location: c,
                                        is_public: +!!p,
                ...
                p = e => {
                    let {
                        ...
                        shareActions: d,
                        onTrack: p
                    } = e, u = "".concat(window.location.origin).concat(t.project_url), m = null != i ? i : u, x = t.custom_title || t.title || "", [h, f] = (0, n.useState)(!1), [b, j] = (0, n.useState)(!1), g = (0, n.useRef)(null);
                    return (0, n.useEffect)(() => {
                        let e = () => {
                                let e = g.current;
                                e && (f(e.scrollLeft > 0), j(e.scrollLeft < e.scrollWidth - e.clientWidth - 1))
                            },
                            t = g.current;
                        ...
                        children: [(0, r.jsx)("div", {
                            ...
                            children: null != s ? s : "Share For More Views"
                        }), (0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)("div", {
                                ...
                                children: d.map(e => (0, r.jsxs)("div", {
                                    ...
                                    onClick: () => {
                                        ...
                                        if (p({
                                                ...
                                                location: l
                                            }), "action" === e.type) e.onClick(r);
                                        else if ("platform" === e.type) {
                                            let t = e.getShareUrl(r);
                                ...
                                children: [(0, r.jsx)("div", {
                                    ...
                                    onClick: () => {
                                        g.current && (g.current.scrollLeft -= 200)
                                    },
                                    children: (0, r.jsx)(a.M0J, {
                                        className: "h-3 w-3"
                                    })
                                }), (0, r.jsx)("div", {
            ...
            let m = e => {
                let {
                    ...
                    return (0, r.jsx)("div", {
                        className: (0, u.cn)("flex h-[120px] w-[120px] flex-shrink-0 items-center justify-center rounded-[12px] border border-black/6"),
                ...
                return (0, r.jsxs)("div", {
                    children: [t && (0, r.jsx)("div", {
                        ...
                        children: a.length > 0 ? a.map(e => (0, r.jsx)(n, {
                            template: e
            ...
            var f = l(34477);
            let b = (0, f.createServerReference)("60182fa22724035bd2ea0477b4c7e412b2b4ddd9be", f.callServer, void 0, f.findSourceMapURL, "genShareUrl"),
                j = (0, f.createServerReference)("4034f60142bdc5bc3b29e96bf1bc96627cac6cc467", f.callServer, void 0, f.findSourceMapURL, "getShareTemplateList"),
                g = (e, t, l) => {
                    let [r, a] = (0, n.useState)(l || []), [c, s] = (0, n.useState)(t || null), [o, i] = (0, n.useState)(null), [d, p] = (0, n.useState)(!1);
                    (0, n.useEffect)(() => {
                        (async () => {
                            if (!(r.length > 0)) try {
                                let t = await j(e);
                                0 === t.code && t.data ? a(t.data.templates) : x.vF.info("get share template list failed", t)
                            } catch (e) {
                                x.vF.error("fetch templates error", e)
                            }
                        })()
                    }, []);
                    let u = (0, n.useCallback)(async t => {
                        s(t), i(null), p(!0);
                        try {
                            let l = await b(e, t.template_id);
                            l.data && t.template_id === l.data.template_id ? i(l.data) : console.log("gen share url res not match", l, t)
                        } catch (e) {
                            x.vF.error("generate share url error", e)
                        } finally {
                            p(!1)
                        }
                    }, [e, c]);
                ...
                w = e => {
                    let {
                        ...
                        selectedTemplate: d,
                        templateCover: m,
                        handleTemplateChange: f
                    } = g(t.project_id, n, c), {
                        track: b
                    } = (0, s.s)(), j = new URL("".concat(window.location.origin).concat(t.project_url));
                    j.searchParams.set("type", "card");
                    let w = async () => {
                            if (m) try {
                                var e;
                                let l = await fetch(m.origin_url),
                                    r = await l.blob(),
                                    a = window.URL.createObjectURL(r),
                                    n = document.createElement("a");
                                n.href = a;
                                let c = (t.title || "".concat(null === (e = t.user) || void 0 === e ? void 0 : e.display_name, "'s YouWare Project")).replace(/\s+/g, "-").toLowerCase();
                                n.download = "".concat(c, "-").concat(null == d ? void 0 : d.template_id, ".png"), document.body.appendChild(n), n.click(), document.body.removeChild(n), window.URL.revokeObjectURL(a)
                            } catch (e) {
                                x.vF.error("Save image failed:", e)
                            }
                        },
                        _ = e => {
                            b("share_card_to_social_platform_click", e)
                        };
                    return (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)("div", {
                                ...
                                children: i.map(e => (0, r.jsx)("div", {
                                    className: (0, u.cn)("flex h-[80px] w-[80px] cursor-pointer items-center justify-center rounded-[12px] border border-black/6", (null == d ? void 0 : d.template_id) === (null == e ? void 0 : e.template_id) ? "border-brand border-2" : ""),
                                    onClick: () => e && f(e),
                                    children: (0, r.jsx)("img", {
                                        src: e.template_icon,
                                        alt: " ",
                            ...
                            onTrack: e => _({ ...e,
                                project_id: t.project_id,
                                template_name: (null == d ? void 0 : d.template_id) || "",
                                template_index: i.indexOf(d || {}) + 1
                            })
                        })]
                    })
                },
                _ = e => {
                    ...
                    let {
                        ...
                        onClose: o,
                        location: i
                    } = e, [u, x] = (0, n.useState)("main"), [f, b] = (0, n.useState)(null), {
                        templates: j
                    } = g(l.project_id), {
                        track: _
                    } = (0, s.s)(), {
                        user: v
                    } = (0, c.A)(), k = (null === (t = l.user) || void 0 === t ? void 0 : t.uid) === (null == v ? void 0 : v.uid), y = e => {
                        "main" === u && (b(e), x("share-template"), _("share_card_template_click", {
                            template_name: e.template_id,
                            template_index: j.indexOf(e) + 1,
                            project_id: l.project_id,
                            project_url: l.project_url,
                            location: i
                        }))
                    }, N = e => {
                        _("share_to_social_platform_click", {
                            project_id: l.project_id,
                    ...
                    return (0, r.jsxs)("div", {
                        ...
                        }), {}), "share-template" === u && (0, r.jsx)(w, {
                            project: l,
                            location: i,
                            initialSelectedTemplate: null != f ? f : void 0,
                            initialTemplates: j,
                            onBack: () => x("main")
                        })]
                    })
