try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "fc83885f-390a-4dad-9fe6-05955a68c1d8", e._sentryDebugIdIdentifier = "sentry-dbid-fc83885f-390a-4dad-9fe6-05955a68c1d8")
} catch (e) {}
"use strict";
    ...
    [1844], {
        19291: (e, t, r) => {
            ...
            class n {
                ...
                get targetWindow() {
                    ...
                    if (this.isParent) {
                        var e;
                        return null === (e = document.querySelector(this.iframeSelector)) || void 0 === e ? void 0 : e.contentWindow
                    }
                ...
                allowOrigin(e) {
                    ...
                    if (!t) {
                        var r;
                        null === (r = this.logger) || void 0 === r || r.warn("Origin rejected", {
                            origin: e,
                ...
                setTarget(e) {
                    var t;
                    this.customTargetWindow = e.window, this.customTargetOrigin = e.origin, null === (t = this.logger) || void 0 === t || t.info("Target updated", {
                        hasWindow: !!e.window,
                        origin: e.origin
                    })
                }
                addAllowedOrigin(e) {
                    if (!this.allowedOrigins.includes(e)) {
                        var t;
                        this.allowedOrigins.push(e), null === (t = this.logger) || void 0 === t || t.info("Added allowed origin pattern", {
                            pattern: e,
                ...
                removeAllowedOrigin(e) {
                    ...
                    if (t > -1) {
                        var r;
                        this.allowedOrigins.splice(t, 1), null === (r = this.logger) || void 0 === r || r.info("Removed allowed origin pattern", {
                            pattern: e,
                            totalPatterns: this.allowedOrigins.length
                        })
                    }
                ...
                sendEvent(e, t) {
                    ...
                    null === (r = this.logger) || void 0 === r || r.info("Sending event", {
                        event: e,
                        messageId: i,
                        dataType: typeof t,
                        maxRetries: n,
                ...
                sendEventWithTransferable(e, t, r) {
                    ...
                    null === (n = this.logger) || void 0 === n || n.info("Sending event with transferable", {
                        event: e,
                        messageId: s,
                        dataType: typeof t,
                ...
                invoke(e, t) {
                    return new Promise((r, n) => {
                        ...
                        null === (o = this.logger) || void 0 === o || o.info("Invoking remote method", {
                            event: e,
                            messageId: s,
                            dataType: typeof t
                        ...
                        let a = setTimeout(() => {
                            if (this.invokeCallbacks.get(s)) {
                                ...
                                null === (t = this.logger) || void 0 === t || t.error(r, {
                                    event: e,
                                    messageId: s
                                }), n(Error(r))
                            }
                        ...
                        this.pending.set(s, {
                            timer: a,
                            attempt: 0
                        }), null === (i = this.targetWindow) || void 0 === i || i.postMessage({
                            id: s,
                            type: "invoke",
                            event: e,
                            data: t
                ...
                invokeWithTransferable(e, t, r) {
                    return new Promise((n, o) => {
                        ...
                        null === (i = this.logger) || void 0 === i || i.info("Invoking remote method with transferable", {
                            event: e,
                            messageId: a,
                            dataType: typeof t,
                            transferableCount: r.length
                        ...
                        this.pending.set(a, {
                            timer: l,
                            attempt: 0
                        }), null === (s = this.targetWindow) || void 0 === s || s.postMessage({
                            id: a,
                            type: "invoke",
                            event: e,
                            data: t
                ...
                sendMessageWithRetry(e, t, r, n) {
                    ...
                    let i = function() {
                        ...
                        if (l > 0 && (null === (a = o.logger) || void 0 === a || a.warn("Message retry attempt", {
                                event: e.event,
                                messageId: e.id,
                                attempt: l + 1,
                                maxAttempts: t + 1
                            })), null === (s = o.targetWindow) || void 0 === s || s.postMessage(e, o.targetOrigin, n), "event" === e.type) {
                            let n = setTimeout(() => {
                                if (l >= t) {
                                    var r;
                                    o.pending.delete(e.id), null === (r = o.logger) || void 0 === r || r.error("Message failed after all retries", {
                                        event: e.event,
                                        messageId: e.id,
                                        totalAttempts: l + 1
                                    });
                ...
                listen() {
                    var e;
                    null === (e = this.logger) || void 0 === e || e.info("Started listening for messages"), window.addEventListener("message", e => {
                        var t, r, n;
                        if (!this.allowOrigin(e.origin) || !(null === (t = e.data) || void 0 === t ? void 0 : t.type) || !(null === (r = e.data) || void 0 === r ? void 0 : r.id)) return;
                        let o = e.data;
                        switch (null === (n = this.logger) || void 0 === n || n.info("Received message", {
                            type: o.type,
                            event: o.event,
                            messageId: o.id,
                            origin: e.origin
                            ...
                            case "event":
                                ...
                                i && i.length > 0 && i.forEach(e => {
                                    try {
                                        ...
                                        var t;
                                        null === (t = this.logger) || void 0 === t || t.error("Event handler error", {
                                            event: o.event,
                ...
                sendAck(e, t) {
                    ...
                    null === (r = this.targetWindow) || void 0 === r || r.postMessage(n, t)
                }
                async handleInvoke(e, t) {
                    ...
                    try {
                        ...
                        if (!a) {
                            ...
                            throw null === (n = this.logger) || void 0 === n || n.error(t, {
                                event: e.event,
                                messageId: e.id
                            }), Error(t)
                        }
                        null === (r = this.logger) || void 0 === r || r.debug("Executing invoke handler", {
                            event: e.event,
                            messageId: e.id
                        });
                        ...
                        c.length > 0 ? (null === (o = this.logger) || void 0 === o || o.debug("Sending response with transferable objects", {
                            event: e.event,
                            originalId: e.id,
                            transferableCount: c.length
                        }), null === (i = this.targetWindow) || void 0 === i || i.postMessage(d, t, c)) : null === (s = this.targetWindow) || void 0 === s || s.postMessage(d, t)
                    } catch (o) {
                        let r = o instanceof Error ? o.message : String(o);
                        null === (a = this.logger) || void 0 === a || a.error("Invoke handler failed", {
                            event: e.event,
                            messageId: e.id,
                            error: r
                        });
                        ...
                        null === (l = this.targetWindow) || void 0 === l || l.postMessage(n, t)
                    }
                }
                ...
                handleResponse(e) {
                    ...
                    o ? (e.error ? (null === (t = this.logger) || void 0 === t || t.error("Invoke failed with error", {
                        originalId: e.originalId,
                        error: e.error
                    }), o.reject(Error(e.error))) : (null === (r = this.logger) || void 0 === r || r.info("Invoke completed successfully", {
                        originalId: e.originalId,
                        resultType: typeof e.data
                    }), o.resolve(e.data)), this.invokeCallbacks.delete(e.originalId)) : null === (n = this.logger) || void 0 === n || n.warn("No callback found for response", {
                        originalId: e.originalId
                    })
                }
                handleAck(e) {
                    ...
                    o ? (clearTimeout(o.timer), this.pending.delete(n), null === (t = this.logger) || void 0 === t || t.debug("ACK received, cleared timeout", {
                        originalId: n
                    })) : null === (r = this.logger) || void 0 === r || r.warn("Received ACK for unknown message", {
                        originalId: n
                    })
                }
                onEvent(e, t) {
                    var r;
                    return this.eventHandlers[e] || (this.eventHandlers[e] = []), this.eventHandlers[e].push(t), null === (r = this.logger) || void 0 === r || r.info("Registered event handler", {
                        event: e,
                        ...
                        if (r) {
                            ...
                            if (o > -1) {
                                var n;
                                r.splice(o, 1), null === (n = this.logger) || void 0 === n || n.info("Removed specific event handler", {
                                    event: e,
                ...
                onInvoke(e, t) {
                    var r;
                    this.invokeHandlers[e] = t, null === (r = this.logger) || void 0 === r || r.info("Registered invoke handler", {
                        event: e
                    })
                }
                offInvoke(e) {
                    var t;
                    delete this.invokeHandlers[e], null === (t = this.logger) || void 0 === t || t.info("Removed invoke handler", {
                        event: e
                    })
                }
                updateLogConfig(e) {
                    var t;
                    void 0 !== e.logger && (this.logger = e.logger), null === (t = this.logger) || void 0 === t || t.info("Log configuration updated", e)
                }
                destroy() {
                    var e, t;
                    null === (e = this.logger) || void 0 === e || e.info("Starting MessageManager cleanup"), this.pending.forEach((e, t) => {
                        clearTimeout(e.timer)
                    }), this.pending.clear(), this.invokeCallbacks.forEach((e, t) => {
                        e.reject(Error("MessageManager destroyed"))
                    }), this.invokeCallbacks.clear(), this.eventHandlers = {}, this.invokeHandlers = {}, null === (t = this.logger) || void 0 === t || t.info("MessageManager destroyed")
                }
                constructor(e) {
                    var t;
        ...
        91844: (e, t, r) => {
            ...
            var l = r(19291),
                ...
                c = r(12115),
                h = r(34477);
            let u = (0, h.createServerReference)("70864e8b5357bb5548f6b0396c48092e508dead20b", h.callServer, void 0, h.findSourceMapURL, "innerRequest");
            var g = r(46116),
                f = r(53568),
                p = r(25427),
                m = r(62128);
            ...
            class y extends c.Component {
                ...
                componentDidCatch(e, t) {
                    ...
                    if (m.Ay.error("Error Boundary caught error in ".concat(n), e, {
                            componentName: n,
                            errorInfo: t.componentStack,
                            retryCount: this.state.retryCount
                        }), this.options.reportToSentry && r.e(1276).then(r.bind(r, 51276)).then(r => {
                            ...
                            m.Ay.error("Failed to report error to Sentry", e)
                        }), this.options.onError) try {
                        this.options.onError(e, t)
                    } catch (e) {
                        m.Ay.error("Error in custom error handler", e)
                    }
                    this.setState({
                        error: e,
                        errorInfo: t
                ...
                render() {
                    ...
                    return e && t ? o ? o(t, this.handleRetry) : n || this.renderDefaultError(t) : r
                }
                constructor(e) {
                    super(e), this.handleRetry = () => {
                        ...
                        if (this.state.retryCount >= e) {
                            m.Ay.warn("Max retries reached (".concat(e, "). Please refresh the page."));
                            return
                        }
                        if (m.Ay.info("Error Boundary retry attempt", {
                            ...
                            m.Ay.error("Error in custom retry handler", e)
                        }
                        this.setState({
                            hasError: !1,
                            error: null,
            ...
            function w(e) {
                let t = (0, c.useRef)(e);
                return t.current = e, (0, c.useCallback)(function() {
            ...
            var k = r(4821),
                ...
                E = r(66139),
                x = r(48436);
            let R = (0, m.tZ)("Fetch Monitor"),
                T = (0, h.createServerReference)("40e9d3331271713c169ab48e54571f7d1a99cc3a6d", h.callServer, void 0, h.findSourceMapURL, "getUserTokenForAIProject");
            ...
            class C {
                static async fetchToken(e) {
                    ...
                    if (0 !== n.code) throw S.error("Failed to fetch token", {
                        projectId: e,
                        error: n.message || "Unknown error"
                    }), Error("Failed to fetch token: ".concat(n.message || "Unknown error"));
                    if (!(null === (t = n.data) || void 0 === t ? void 0 : t.token) || !(null === (r = n.data) || void 0 === r ? void 0 : r.expires_in)) throw S.error("Invalid token response", {
                        projectId: e,
            ...
            let S = (0, m.tZ)("LLMToken");
            class M {
                async getToken() {
                    if (this.isDestroyed) throw new A("TokenManager has been destroyed", "DESTROYED");
                    if (this.tokenInfo && this.tokenInfo.expiresTime > Date.now()) return this.tokenInfo.token;
                    if (this.refreshPromise || (this.refreshPromise = this.refreshToken()), await this.refreshPromise, !this.tokenInfo) throw new A("Failed to obtain token", "FETCH_FAILED");
                ...
                async refreshToken() {
                    ...
                    if (!this.isDestroyed) {
                        ...
                        try {
                            S.info("Refreshing llm-token", {
                                projectId: this.config.projectId
                            });
                            let e = await this.tokenFetcher(this.config.projectId);
                            if (!e.token || !e.expires_in) throw new A("Invalid token response", "INVALID_RESPONSE", !0);
                            this.tokenInfo = {
                                token: e.token,
                                expiresTime: Date.now() + 1e3 * e.expires_in - 5e3
                            }, this.scheduleNextRefresh(e.expires_in), this.refreshPromise = null, S.info("llm-token refreshed successfully", {
                                projectId: this.config.projectId,
                            ...
                            if (this.isRetryableError(t) && e < this.config.retryConfig.maxAttempts) {
                                ...
                                if (S.error("Retrying llm-token fetch (attempt ".concat(e + 1, "/").concat(this.config.retryConfig.maxAttempts, ") in ").concat(r, "ms"), {
                                        projectId: this.config.projectId,
                                        error: t
                                    }), await new Promise(e => {
                                ...
                                let r = t instanceof Error ? t.message : String(t),
                                    n = new A("Failed to fetch token after ".concat(e + 1, " attempts: ").concat(r), "MAX_RETRIES_EXCEEDED");
                                throw S.error("Failed to fetch token after ".concat(this.config.retryConfig.maxAttempts, " attempts"), n, {
                                    projectId: this.config.projectId,
                                    originalError: t
                                }), n
                            }
                ...
                isRetryableError(e) {
                    return e instanceof A ? e.retryable : !(e instanceof Error) || e.message.includes("network") || e.message.includes("timeout") || e.message.includes("fetch")
                }
            ...
            let _ = {
                ...
                j = (0, c.forwardRef)((e, t) => {
                    let {
                        ...
                        title: T = "Preview",
                        seamless: S = !1,
                        allow: j = "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; camera; microphone; geolocation; fullscreen; payment",
                        sandbox: q = "allow-downloads allow-forms allow-modals allow-orientation-lock allow-pointer-lock allow-popups allow-popups-to-escape-sandbox allow-presentation allow-same-origin allow-scripts allow-top-navigation",
                        loading: O = "eager",
                        onRequestLogin: P,
                        ...N
                    } = e, L = (0, c.useRef)(null), [W, F] = (0, c.useState)(() => Date.now()), {
                        track: H
                    } = (0, I.s)(), [U, B] = (0, c.useState)(!1), {
                        user: X
                    } = (0, f.A)(), Y = (0, d.useRouter)(), z = w(() => r.project_id);
                    ! function(e) {
                        let t = w(e.getLoginStatus),
                            r = w(e.requestLogin);
                        (0, c.useEffect)(() => {
                            var t, r;
                            return t = e.getLoginStatus, r = e.requestLogin, l.d.onInvoke("getLoginStatus", async () => t()), l.d.onInvoke("requestLogin", async e => r(e)), () => {
                        ...
                        innerRequest: async (e, t) => {
                            D.info("innerRequest", {
                                ...
                                X ? e(!0) : (0, k.S)({
                                    ...
                                    onConfirm: () => {
                                        let t = (0, E.$)(!0, !0) + window.location.pathname + window.location.search;
                                        Y.push("".concat((0, E.$)(!0), "/login?returnTo=").concat(encodeURIComponent(t))), e(!0)
                                    }
                                })
                            });
                            try {
                                ...
                                return D.info("innerRequest result", n), n
                            } catch (e) {
                                throw D.error("innerRequest error", e), e
                            }
                        }
                    ...
                    let {
                        ...
                        let {
                            projectId: t,
                            refreshAdvanceTime: r = _.refreshAdvanceTime,
                            maxRetryAttempts: n = _.maxRetryAttempts,
                            baseRetryDelay: o = _.baseRetryDelay,
                            maxRetryDelay: i = _.maxRetryDelay
                        } = e, [s, a] = (0, c.useState)(!1), [l, d] = (0, c.useState)(null), h = (0, c.useRef)(null);
                        return (0, c.useEffect)(() => (h.current = new M({
                            projectId: t,
                            ...
                            var e;
                            null === (e = h.current) || void 0 === e || e.destroy(), h.current = null
                        }), [t, r, n, o, i]), {
                            getToken: (0, c.useCallback)(async () => {
                                if (!h.current) throw new A("TokenManager not initialized", "NOT_INITIALIZED");
                                a(!0), d(null);
                                try {
                                    return await h.current.getToken()
                                } catch (t) {
                                    let e = t instanceof A ? t : new A(t instanceof Error ? t.message : String(t), "UNKNOWN_ERROR");
                                    throw d(e), e
                                } finally {
                                    a(!1)
                                }
                    ...
                    return (0, c.useEffect)(() => {
                        ...
                        let t = (e = async () => {
                                ...
                                let e = await K();
                                return D.info("getToken success", {
                                    projectId: r.project_id
                                }), e
                            }, async t => {
                                let r = await e();
                                t.headers.set("Authorization", "Bearer ".concat(r))
                            }),
                            n = async e => {
                                let t = "http://yourware-backend-prod.yourware-service-discovery-prod:8000";
                                if (t && e.url.includes("api.youware.com")) {
                                    ...
                                    e.url = e.url.replace("api.youware.com", r)
                                }
                            },
                            d = async e => {
                                H("call_ai_adk", {
                                ...
                                if (t && "0" !== t) {
                                    if (H("call_ai_adk_error", {
                                        ...
                                        B(!0), b.X.sendMessage("CreditsUpdated");
                                        return
                                    }(0, x.P)({
                                ...
                                try {
                                    ...
                                    if (e) {
                                        if (null == r ? void 0 : r.onResponse) {
                                            ...
                                            let o = function(e, t) {
                                                var r;
                                                let n = (null === (r = t.get("content-type")) || void 0 === r ? void 0 : r.toLowerCase()) || "";
                            ...
                            monitor: {
                                ...
                                onResponse: e => {
                                    let t = function(e) {
                                        var t, r;
                                        let n = e.body;
                                        if (((null === (r = e.headers) || void 0 === r ? void 0 : null === (t = r.get) || void 0 === t ? void 0 : t.call(r, "content-type")) || "").includes("text/event-stream") && "string" == typeof e.body) try {
                                            n = function(e) {
                                            ...
                                            R.error("Failed to parse SSE content:", t instanceof Error ? t : Error(String(t))), n = e.body
                                        }
                                        return n
                                    }(e);
                                    if (e.status >= 300) {
                                        ...
                                        R.error("request failed", {
                                            ...
                                            status: e.status,
                                            duration: e.duration,
                                            xw_status: null === (r = e.headers) || void 0 === r ? void 0 : r.get("X-YW-Status"),
                                            xw_message: null === (n = e.headers) || void 0 === n ? void 0 : n.get("X-YW-Message"),
                                            body: t
                                        })
                                    }
                                },
                        ...
                        children: [(0, n.jsx)(g.p, {
                            isOpen: U,
                            onClose: () => B(!1),
                            from: "editor" === p ? "editor_AI_API_pop_up" : "app_page_AI_API_pop_up"
                        }), (0, n.jsx)("iframe", {
                            ref: L,
                            id: "youware-runtime",
                            src: h,
            ...
            let q = function(e) {
                ...
                return o.displayName = "withErrorBoundary(".concat(r, ")"), o
            }(j)
        }
    }
]);