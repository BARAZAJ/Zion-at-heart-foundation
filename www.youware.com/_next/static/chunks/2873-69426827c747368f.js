try {
    let e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        t = (new e.Error).stack;
    t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "f3b11e7e-f323-40b6-8f2f-34a8680e7f2f", e._sentryDebugIdIdentifier = "sentry-dbid-f3b11e7e-f323-40b6-8f2f-34a8680e7f2f")
    ...
    [2873], {
        ...
        16203: (e, t, r) => {
            ...
            var n = r(20706);
            r(46235), r(49887), r(10796), r(56391)
        },
        20996: (e, t, r) => {
            "use strict";
            r.d(t, {
            ...
            function C(e, t) {
                ...
                I(r, t),
                    function(e, t) {
                        let r = function() {
                            return !_ && "BroadcastChannel" in self && ((_ = new BroadcastChannel("[Firebase] FID Change")).onmessage = e => {
                                I(e.data.key, e.data.fid)
                            }), _
                        }();
                        r && r.postMessage({
                                key: e,
            ...
            let _ = null,
                R = "firebase-installations-store",
                k = null;

            function D() {
                return k || (k = (0, l.P2)("firebase-installations-database", 1, {
                    upgrade: (e, t) => {
                        0 === t && e.createObjectStore(R)
                    }
                })), k
            }
            async function B(e, t) {
                let r = O(e),
                    n = (await D()).transaction(R, "readwrite"),
                    i = n.objectStore(R),
                    o = await i.get(r);
            ...
            async function j(e) {
                let t = O(e),
                    r = (await D()).transaction(R, "readwrite");
            ...
            async function P(e, t) {
                try {
                    ...
                    throw p(r) && 409 === r.customData.serverCode ? await j(e.appConfig) : await B(e.appConfig, {
                        fid: t.fid,
                        registrationStatus: 0
                    }), r
                }
            ...
            async function L(e) {
                let t = await U(e.appConfig);
                for (; 1 === t.registrationStatus;) await S(100), t = await U(e.appConfig);
                if (0 === t.registrationStatus) {
                    let {
                        installationEntry: t,
            ...
            async function $(e, t = !1) {
                let r;
                let n = await x(e.appConfig, n => {
                    var i;
                    if (!W(n)) throw d.create("not-registered");
                    let o = n.authToken;
            ...
            async function H(e, t) {
                ...
                for (; 1 === r.authToken.requestStatus;) await S(100), r = await z(e.appConfig);
                let n = r.authToken;
                return 0 === n.requestStatus ? $(e, t) : n
            }

            function z(e) {
                return x(e, e => {
                    var t;
                    if (!W(e)) throw d.create("not-registered");
            ...
            async function q(e, t) {
                try {
                    ...
                    if (p(r) && (401 === r.customData.serverCode || 404 === r.customData.serverCode)) await j(e.appConfig);
                    else {
            ...
            async function K(e) {
                ...
                return r ? r.catch(console.error) : $(e).catch(console.error), t.fid
            }
            async function V(e, t = !1) {
                return await J(e), (await $(e, t)).token
            }
            async function J(e) {
                let {
                    registrationPromise: t
            ...
            (0, o.om)(new a.uA(X, e => {
                ...
                let t = e.getProvider("app").getImmediate(),
                    r = (0, o.j6)(t, X).getImmediate();
                return {
                    getId: () => K(r),
                    getToken: e => V(r, e)
                }
            }, "PRIVATE")), (0, o.KO)(u, c), (0, o.KO)(u, c, "esm2017");
            let Y = "BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",
                Z = "google.c.a.c_id";
            ...
            let ee = "fcm_token_details_db",
                et = "fcm_token_object_Store";
            async function er(e) {
                if ("databases" in indexedDB && !(await indexedDB.databases()).map(e => e.name).includes(ee)) return null;
                let t = null;
                return (await (0, l.P2)(ee, 5, {
                    upgrade: async (r, n, i, o) => {
                        var a;
                        if (n < 2 || !r.objectStoreNames.contains(et)) return;
                        let s = o.objectStore(et),
                        ...
                        if (await s.clear(), l) {
                            if (2 === n) {
                                ...
                                t = {
                                    token: l.fcmToken,
                                    createTime: null !== (a = l.createTime) && void 0 !== a ? a : Date.now(),
                                    subscriptionOptions: {
                                        auth: l.auth,
                                        p256dh: l.p256dh,
                                        endpoint: l.endpoint,
                                        swScope: l.swScope,
                                        vapidKey: "string" == typeof l.vapidKey ? l.vapidKey : Q(l.vapidKey)
                                    }
                                }
                            } else 3 === n ? t = {
                                token: l.fcmToken,
                ...
                })).close(), await (0, l.MR)(ee), await (0, l.MR)("fcm_vapid_details_db"), await (0, l.MR)("undefined"), ! function(e) {
            ...
            let en = "firebase-messaging-store",
                ei = null;

            function eo() {
                return ei || (ei = (0, l.P2)("firebase-messaging-database", 1, {
                    upgrade: (e, t) => {
                        0 === t && e.createObjectStore(en)
                    }
                })), ei
            }
            async function ea(e) {
                let t = function({
                    ...
                    r = await eo(),
                    n = await r.transaction(en).objectStore(en).get(t);
                if (n) return n; {
                    let t = await er(e.appConfig.senderId);
                    if (t) return await es(e, t), t
                }
            }
            async function es(e, t) {
                let r = function({
                    ...
                    n = (await eo()).transaction(en, "readwrite");
                return await n.objectStore(en).put(t, r), await n.done, t
            }
            async function el(e) {
                let t = function({
                        appConfig: e
                    ...
                    r = (await eo()).transaction(en, "readwrite");
                await r.objectStore(en).delete(t), await r.done
            }
            let eu = new s.FA("messaging", "Messaging", {
                "missing-app-config-values": 'Missing App configuration value: "{$valueName}"',
            ...
            async function ec(e, t) {
                ...
                try {
                    let t = await fetch(ed(e.appConfig), n);
                    r = await t.json()
                } catch (e) {
                    throw eu.create("token-subscribe-failed", {
                ...
                if (!r.token) throw eu.create("token-subscribe-no-token");
                return r.token
            }
            async function ef(e, t) {
                ...
                try {
                    let i = await fetch(`${ed(e.appConfig)}/${t.token}`, n);
                    r = await i.json()
                } catch (e) {
                    throw eu.create("token-update-failed", {
                        errorInfo: null == e ? void 0 : e.toString()
                    })
                }
                if (r.error) {
                ...
                if (!r.token) throw eu.create("token-update-no-token");
                return r.token
            }
            async function eh(e, t) {
                let r = await ep(e);
                try {
                    let n = await fetch(`${ed(e.appConfig)}/${t}`, {
                            method: "DELETE",
                            headers: r
                        }),
                        i = await n.json();
                    if (i.error) {
                        ...
                        throw eu.create("token-unsubscribe-failed", {
                            errorInfo: e
                        })
                    }
                } catch (e) {
            ...
            function eg({
                ...
                return n !== Y && (i.web.applicationPubKey = n), i
            }
            async function em(e) {
                let t = await ev(e.swRegistration, e.vapidKey),
                    r = {
                        vapidKey: e.vapidKey,
                        swScope: e.swRegistration.scope,
                        endpoint: t.endpoint,
                        auth: Q(t.getKey("auth")),
                        p256dh: Q(t.getKey("p256dh"))
                    },
                    n = await ea(e.firebaseDependencies);
                ...
                if (function(e, t) {
                        let r = t.vapidKey === e.vapidKey,
                            ...
                            o = t.p256dh === e.p256dh;
                        return r && n && i && o
                    }(n.subscriptionOptions, r)) return Date.now() >= n.createTime + 6048e5 ? ey(e, {
                    token: n.token,
                    createTime: Date.now(),
            ...
            async function eb(e) {
                let t = await ea(e.firebaseDependencies);
                t && (await eh(e.firebaseDependencies, t.token), await el(e.firebaseDependencies));
                let r = await e.swRegistration.pushManager.getSubscription();
                return !r || r.unsubscribe()
            }
            async function ey(e, t) {
                try {
                    let r = await ef(e.firebaseDependencies, t),
                        n = Object.assign(Object.assign({}, t), {
                            token: r,
                            createTime: Date.now()
                        });
                    return await es(e.firebaseDependencies, n), r
                } catch (e) {
                    throw e
                }
            }
            ...
            function eE(e) {
                ...
                return function(e, t) {
                    ...
                    function(e, t) {
                        ...
                        e.fcmOptions = {};
                        let s = null !== (i = null === (n = t.fcmOptions) || void 0 === n ? void 0 : n.link) && void 0 !== i ? i : null === (o = t.notification) || void 0 === o ? void 0 : o.click_action;
                        s && (e.fcmOptions.link = s);
                        let l = null === (a = t.fcmOptions) || void 0 === a ? void 0 : a.analytics_label;
                        l && (e.fcmOptions.analyticsLabel = l)
                    }(n, e), n
            }

            function eS(e) {
                return eu.create("missing-app-config-values", {
                    valueName: e
                })
            }! function(e, t) {
                let r = [];
            ...
            class eA {
                constructor(e, t, r) {
                    ...
                    let n = function(e) {
                        if (!e || !e.options) throw eS("App Configuration Object");
                        if (!e.name) throw eS("App Name");
                        let {
                            options: t
                        } = e;
            ...
            async function eO(e) {
                try {
                    ...
                    }), e.swRegistration.update().catch(() => {}), await eT(e.swRegistration)
                } catch (e) {
                    throw eu.create("failed-service-worker-registration", {
            ...
            async function eT(e) {
                return new Promise((t, r) => {
                    ...
                    e.active ? (clearTimeout(n), t()) : i ? i.onstatechange = e => {
                        var r;
                        (null === (r = e.target) || void 0 === r ? void 0 : r.state) === "activated" && (i.onstatechange = null, clearTimeout(n), t())
                    } : (clearTimeout(n), r(Error("No incoming service worker found.")))
                })
            }
            async function eC(e, t) {
                if (t || e.swRegistration || await eO(e), t || !e.swRegistration) {
                    if (!(t instanceof ServiceWorkerRegistration)) throw eu.create("invalid-sw-registration");
                    e.swRegistration = t
                }
            }
            async function eI(e, t) {
                t ? e.vapidKey = t : e.vapidKey || (e.vapidKey = Y)
            }
            async function e_(e, t) {
                if (!navigator) throw eu.create("only-available-in-window");
                if ("default" === Notification.permission && await Notification.requestPermission(), "granted" !== Notification.permission) throw eu.create("permission-blocked");
                return await eI(e, null == t ? void 0 : t.vapidKey), await eC(e, null == t ? void 0 : t.serviceWorkerRegistration), em(e)
            }
            ...
            async function ek(e, t) {
                ...
                e.onMessageHandler && r.messageType === i.PUSH_RECEIVED && ("function" == typeof e.onMessageHandler ? e.onMessageHandler(eE(r)) : e.onMessageHandler.next(eE(r)));
                let n = r.data;
                "object" == typeof n && n && Z in n && "1" === n["google.c.a.e"] && await eR(e, r.messageType, n)
            }
            let eD = "@firebase/messaging",
                eB = "0.12.17";
            async function ej() {
                try {
                    await (0, s.eX)()
            ...
            function ex(e = (0, o.Sx)()) {
                return ej().then(e => {
                    if (!e) throw eu.create("unsupported-browser")
                }, e => {
                    throw eu.create("indexed-db-unsupported")
                }), (0, o.j6)((0, s.Ku)(e), "messaging").getImmediate()
            }
            async function eN(e, t) {
                return e_(e = (0, s.Ku)(e), t)
            }
            ...
            function eP(e, t) {
                ...
                let t = new eA(e.getProvider("app").getImmediate(), e.getProvider("installations-internal").getImmediate(), e.getProvider("analytics-internal"));
                return navigator.serviceWorker.addEventListener("message", e => ek(t, e)), t
            }, "PUBLIC")), (0, o.om)(new a.uA("messaging-internal", e => {
                let t = e.getProvider("messaging").getImmediate();
                return {
                    getToken: e => e_(t, e)
                }
            }, "PRIVATE")), (0, o.KO)(eD, eB), (0, o.KO)(eD, eB, "esm2017")
        },
        23464: (e, t, r) => {
            "use strict";
            let n;
            ...
            let x = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : global,
                ...
                z = "undefined" != typeof queueMicrotask ? queueMicrotask.bind(x) : void 0 !== u && u.nextTick || H,
                q = {
                    isArray: g,
                    isArrayBuffer: b,
                    isBuffer: function(e) {
            ...
            }), Object.defineProperties(W, V), Object.defineProperty(K, "isAxiosError", {
                value: !0
            }), W.from = (e, t, r, n, i, o) => {
                let a = Object.create(K);
                return q.toFlatObject(e, a, function(e) {
                    return e !== Error.prototype
                }, e => "isAxiosError" !== e), W.call(a, e.message, t, r, n, i), a.cause = e, a.name = e.name, o && Object.assign(a, o), a
            };
            ...
            let Z = q.toFlatObject(q, {}, null, function(e) {
                ...
                Q = function(e, t, r) {
                    ...
                    function l(e) {
                        ...
                        if (!s && q.isBlob(e)) throw new W("Blob is not supported. Use a Buffer instead.");
                    ...
                    function u(e, r, i) {
                        ...
                        if (e && !i && "object" == typeof e) {
                            if (q.endsWith(r, "{}")) r = n ? r : r.slice(0, -2), e = JSON.stringify(e);
                                ...
                                var u;
                                if (q.isArray(e) && (u = e, q.isArray(u) && !u.some(G)) || (q.isFileList(e) || q.endsWith(r, "[]")) && (s = q.toArray(e))) return r = X(r), s.forEach(function(e, n) {
                                    q.isUndefined(e) || null === e || t.append(!0 === a ? Y([r], n, o) : null === a ? r : r + "[]", l(e))
                                }), !1
                            }
                        }
            ...
            class eT {
                ...
                set(e, t, r) {
                    ...
                    else if (q.isString(e) && (e = e.trim()) && !eA(e)) o(ew(e), t);
            ...
            function eR(e, t, r) {
                ...
                !r.status || !n || n(r.status) ? e(r) : t(new W("Request failed with status code " + r.status, [W.ERR_BAD_REQUEST, W.ERR_BAD_RESPONSE][Math.floor(r.status / 100) - 4], r.config, r.request, r))
            }
            ...
            }), q.freezeMethods(eT), q.inherits(e_, W, {
                __CANCEL__: !0
            });
            let ek = function(e, t) {
                    let r;
                ...
                ex = e => (...t) => q.asap(() => e(...t)),
                eN = eg.hasStandardBrowserEnv ? ((e, t) => r => (r = new URL(r, eg.origin), e.protocol === r.protocol && e.host === r.host && (t || e.port === r.port)))(new URL(eg.origin), eg.navigator && /(msie|trident)/i.test(eg.navigator.userAgent)) : () => !0,
            ...
            let eF = e => {
                    ...
                    if (r.headers = s = eT.from(s), r.url = ei(eL(r.baseURL, r.url, r.allowAbsoluteUrls), e.params, e.paramsSerializer), l && s.set("Authorization", "Basic " + btoa((l.username || "") + ":" + (l.password ? unescape(encodeURIComponent(l.password)) : ""))), q.isFormData(n)) {
                    ...
                    if (eg.hasStandardBrowserEnv && (i && q.isFunction(i) && (i = i(r)), i || !1 !== i && eN(r.url))) {
                        let e = o && a && eP.read(a);
                        e && s.set(o, e)
                    }
                    return r
                    ...
                    return new Promise(function(t, r) {
                        ...
                        g.open(l.method.toUpperCase(), l.url, !0), g.timeout = l.timeout, "onloadend" in g ? g.onloadend = m : g.onreadystatechange = function() {
                            ...
                            let t = l.timeout ? "timeout of " + l.timeout + "ms exceeded" : "timeout exceeded",
                                n = l.transitional || ea;
                            l.timeoutErrorMessage && (t = l.timeoutErrorMessage), r(new W(t, n.clarifyTimeoutError ? W.ETIMEDOUT : W.ECONNABORTED, e, g)), g = null
                        }, void 0 === u && c.setContentType(null), "setRequestHeader" in g && q.forEach(c.toJSON(), function(e, t) {
                            g.setRequestHeader(t, e)
                        }), q.isUndefined(l.withCredentials) || (g.withCredentials = !!l.withCredentials), f && "json" !== f && (g.responseType = l.responseType), d && ([o, s] = eB(d, !0), g.addEventListener("progress", o)), h && g.upload && ([i, a] = eB(h), g.upload.addEventListener("progress", i), g.upload.addEventListener("loadend", a)), (l.cancelToken || l.signal) && (n = t => {
                        ...
                        let r, n = new AbortController,
                            i = function(e) {
                                if (!r) {
                                    ...
                                    n.abort(t instanceof W ? t : new e_(t instanceof Error ? t.message : t))
                                }
                            },
                            o = t && setTimeout(() => {
                ...
                eq = async function*(e, t) {
                    for await (let r of eW(e)) yield* ez(r, t)
                },
                eW = async function*(e) {
                ...
                eV = "function" == typeof fetch && "function" == typeof Request && "function" == typeof Response,
                eJ = eV && "function" == typeof ReadableStream,
                eG = eV && ("function" == typeof TextEncoder ? (n = new TextEncoder, e => n.encode(e)) : async e => new Uint8Array(await new Response(e).arrayBuffer())),
                eX = (e, ...t) => {
                    try {
                        return !!e(...t)
                    } catch (e) {
                ...
                eZ = eJ && eX(() => q.isReadableStream(new Response("").body)),
                eQ = {
                    stream: eZ && (e => e.body)
                };
            eV && (a = new Response, ["text", "arrayBuffer", "blob", "formData", "stream"].forEach(e => {
                eQ[e] || (eQ[e] = q.isFunction(a[e]) ? t => t[e]() : (t, r) => {
            ...
            let e0 = async e => {
                    ...
                    return q.isArrayBufferView(e) || q.isArrayBuffer(e) ? e.byteLength : (q.isURLSearchParams(e) && (e += ""), q.isString(e)) ? (await eG(e)).byteLength : void 0
                },
                e1 = async (e, t) => {
                ...
                e2 = {
                    ...
                    fetch: eV && (async e => {
                        ...
                        let g = eH([a, s && s.toAbortSignal()], l),
                            m = g && g.unsubscribe && (() => {
                                g.unsubscribe()
                            });
                        try {
                            if (c && eY && "get" !== i && "head" !== i && 0 !== (r = await e1(h, o))) {
                                ...
                                if (q.isFormData(o) && (e = t.headers.get("content-type")) && h.setContentType(e), t.body) {
                                    let [e, n] = ej(r, eB(ex(c)));
                                    o = eK(t.body, 65536, e, n)
                                }
                            }
                            ...
                            if (eZ && (u || l && m)) {
                                ...
                                let t = q.toFiniteNumber(s.headers.get("content-length")),
                                    [r, n] = u && ej(t, eB(ex(u), !0)) || [];
                                s = new Response(eK(s.body, 65536, r, () => {
                                    n && n(), m && m()
                                }), e)
                            }
                            f = f || "text";
                            let b = await eQ[q.findKey(eQ, f) || "text"](s, e);
                            ...
                            if (m && m(), r && "TypeError" === r.name && /fetch/i.test(r.message)) throw Object.assign(new W("Network Error", W.ERR_NETWORK, e, t), {
                                cause: r.cause || r
                            });
            ...
            let e6 = e => `- ${e}`,
                e5 = e => q.isFunction(e) || null === e || !1 === e,
                e3 = {
                    getAdapter: e => {
                        let t, r;
                        let {
                        ...
                        for (let o = 0; o < n; o++) {
                            let n;
                            if (r = t = e[o], !e5(t) && void 0 === (r = e2[(n = String(t)).toLowerCase()])) throw new W(`Unknown adapter '${n}'`);
                            if (r) break;
                            i[n || "#" + o] = r
                        }
                        if (!r) {
            ...
            function e4(e) {
                return e8(e), e.headers = eT.from(e.headers), e.data = eC.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1), e3.getAdapter(e.adapter || eb.adapter)(e).then(function(t) {
                    return e8(e), t.data = eC.call(e, e.transformResponse, t), t.headers = eT.from(t.headers), t
                }, function(t) {
                    return !eI(t) && (e8(e), t && t.response && (t.response.data = eC.call(e, e.transformResponse, t.response), t.response.headers = eT.from(t.response.headers))), Promise.reject(t)
                })
            }
            let e9 = "1.8.4",
                e7 = {};
            ...
            class tn {
                ...
                getUri(e) {
                    return ei(eL((e = eM(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls), e.params, e.paramsSerializer)
                }
            }
            ...
            let ta = function e(t) {
                ...
                return q.extend(n, tn.prototype, r, {
                    allOwnKeys: !0
                }), q.extend(n, r, null, {
                    allOwnKeys: !0
                }), n.create = function(r) {
            ...
            ta.Axios = tn, ta.CanceledError = e_, ta.CancelToken = ti, ta.isCancel = eI, ta.VERSION = e9, ta.toFormData = Q, ta.AxiosError = W, ta.Cancel = ta.CanceledError, ta.all = function(e) {
            ...
            }, ta.mergeConfig = eM, ta.AxiosHeaders = eT, ta.formToJSON = e => em(q.isHTMLForm(e) ? new FormData(e) : e), ta.getAdapter = e3.getAdapter, ta.HttpStatusCode = to, ta.default = ta;
            let ts = ta
        },
        23915: (e, t, r) => {
            "use strict";
        ...
        46235: (e, t, r) => {
            ...
            async function I(e) {
                let t = !1,
                    r = e.name;
                d.has(r) ? (t = !0, d.delete(r)) : p.has(r) && 0 >= e.decRefCount() && (p.delete(r), t = !0), t && (await Promise.all(e.container.getProviders().map(e => e.delete())), e.isDeleted = !0)
            }
            ...
            let R = "firebase-heartbeat-store",
                k = null;

            function D() {
                return k || (k = (0, a.P2)("firebase-heartbeat-database", 1, {
                    upgrade: (e, t) => {
                        if (0 === t) try {
            ...
            async function B(e) {
                try {
                    let t = (await D()).transaction(R),
                        r = await t.objectStore(R).get(x(e));
            ...
            async function j(e, t) {
                try {
                    let r = (await D()).transaction(R, "readwrite"),
                        n = r.objectStore(R);
            ...
            b(new n.uA("platform-logger", e => new s(e), "PRIVATE")), b(new n.uA("heartbeat", e => new N(e), "PRIVATE")), _(l, u, ""), _(l, u, "esm2017"), _("fire-js", "")
        },
        46984: (e, t, r) => {
            "use strict";
            let n, i;
            ...
            function h(e) {
                ...
                let t = function(e) {
                    if ("function" == typeof e) return e !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (i || (i = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(e) ? function(...t) {
                        return e.apply(d(this), t), h(a.get(this))
                    } : function(...t) {
                        return h(e.apply(d(this), t))
                    } : function(t, ...r) {
                ...
                return t !== e && (u.set(e, t), c.set(t, e)), t
            }
            let d = e => c.get(e);
            ...
            function p(e, t, {
                ...
                return n && a.addEventListener("upgradeneeded", e => {
                    n(h(a.result), e.oldVersion, e.newVersion, h(a.transaction), e)
            ...
            function g(e, {
                ...
                return t && r.addEventListener("blocked", e => t(e.oldVersion, e)), h(r).then(() => void 0)
            }
        ...
        49887: (e, t, r) => {
                ...
                s = {
                    ...
                    decodeStringToByteArray(e, t) {
                        ...
                        for (let t = 0; t < e.length;) {
                            ...
                            if (++t, null == i || null == o || null == a || null == s) throw new l;
                            let u = i << 2 | o >> 4;
                            if (n.push(u), 64 !== a) {
                                let e = o << 4 & 240 | a >> 2;
                                if (n.push(e), 64 !== s) {
            ...
            class R extends Error {
                constructor(e, t, r) {
                    super(t), this.code = e, this.customData = r, this.name = "FirebaseError", Object.setPrototypeOf(this, R.prototype), Error.captureStackTrace && Error.captureStackTrace(this, k.prototype.create)
                }
            }
            class k {
                constructor(e, t, r) {
            ...
            class U {
                ...
                subscribe(e, t, r) {
                    ...
                    void 0 === (n = ! function(e, t) {
                        ...
                        error: t,
                        complete: r
                    } : e).next && (n.next = M), void 0 === n.error && (n.error = M), void 0 === n.complete && (n.complete = M);
